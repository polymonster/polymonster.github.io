...
There have been a lot of changes and additions to the c++ standard since I started using c++ in the early 2000's, the language itself has started to look quite different. Yet still I am using a very stripped down subset of c++ actually more c-style and only reaching for c++ and modern c++ with careful consideration. Why is this? Because I have never really coveted new language features, I have always been more focused on the 'details' like the maths behind graphics effects or physics mechanics and not so much about the 'glue' of how it all fits together. I worked on and shipped games and products pre c++11, found and saw, effective techniques that worked well and stuck with them. These techniques provide good performance even in debug builds.
