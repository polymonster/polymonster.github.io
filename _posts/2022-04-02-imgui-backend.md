...
description: 'How I implemented a feature-complete Dear ImGui rendering and platform backend in Rust with docking, multi-viewport support, and input handling using the hotline engine APIs.'
---
