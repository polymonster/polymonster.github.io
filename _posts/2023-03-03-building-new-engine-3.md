...
description: 'The most challenging leg of the hotline Rust graphics engine: plugins, multi-threaded command buffer generation, and hot reloading for Rust code, HLSL shaders, and render configs.'
---
